...
import {
  Hexagon, Plus, Settings, HelpCircle, LayoutGrid, List,
  CalendarDays, Upload, Activity, Thermometer, Droplets,
  Weight, ChevronRight, AlertTriangle, CheckCircle, Leaf,
  Crown, Users, BarChart2,
} from "lucide-react";
      ...
      >
        ...
        <nav className="flex-1 px-3 space-y-0.5">
          {[
            ...
            { label: "Colonies", icon: Hexagon, active: true },
